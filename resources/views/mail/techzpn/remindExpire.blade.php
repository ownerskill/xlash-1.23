...
<head>
    <meta charset="UTF-8">
    <title>Nhắc nhở hết hạn sử dụng gói dịch vụ</title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            Gói dịch vụ của bạn sẽ hết hạn trong <strong>24</strong> giờ tới, vui lòng gia hạn gói dịch vụ để tránh gián đoạn trong quá trình sử dụng.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            (Email này do hệ thống gửi tự động, vui lòng không trả lời lại.)
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
