...
<head>
    <meta charset="UTF-8">
    <title>TECHZPN.PRO PRIVATE NETWORK</title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
...
<body itemscope itemtype="http://schema.org/EmailMessage"
    ...
    <table class="body-wrap"
        ...
        <tr
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; vertical-align: top; line-height: 1em; margin: 0; padding: 20px 0 30px; text-align: center"
                                            valign="top">
                                            Xin chào bạn,chào mừng bạn đến với TECHZPN.PRO !
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; color: #4a4a4a; vertical-align: top; margin: 0; padding: 0 0 20px; text-align: center"
                                            valign="top">
                                            Mã Xác Minh E-mail Của Bạn Là <font color="red" >{{$code}}</font>
                                        </td>
                                    </tr>
            ...
            <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; text-align: center"
                valign="top">
            </td>
        </tr>
    </table>
