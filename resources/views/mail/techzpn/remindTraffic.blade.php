...
<head>
    <meta charset="UTF-8">
    <title>Thông báo dung lượng</title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                             Dung lượng của bạn trong tháng này đã được sử dụng <strong>80%</strong>，hãy sử dụng dung lượng hợp lý để tránh bị gián đoạn trong quá trình sử dụng.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
